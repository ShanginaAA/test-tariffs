...
const PrivacyPolicy: FC<PrivacyPolicyProps> = ({ isChecked, showError, onClick }) => {
  return (
    <div className="absolute left-[15px] top-[1007px] sm:left-4 md:left-[820px] sm:top-[1105px] md:top-[974px] flex flex-row items-center gap-2.5 sm:gap-3 ">
      <input
        type="checkbox"
      ...
      />
      <div
        className={`w-[30px] h-[30px] md:w-8 md:h-8 rounded-sm flex items-center justify-center 
        border-solid border-2 border-[#606566] ${showError ? 'border border-red-700' : ''}`}
      >
        {/* Галочка */}
        {isChecked && (
          <svg
      ...
      <span className="font-[400] text-xs md:text-base leading-[110%] w-[252px] sm:w-[297px] md:w-[605px]">
